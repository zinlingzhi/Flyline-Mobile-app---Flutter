...
import 'package:motel/modules/hotelDetailes/hotelRoomeList.dart';
import 'package:motel/modules/hotelDetailes/ratingView.dart';
import 'package:motel/modules/hotelDetailes/reviewsListScreen.dart';
...
class _HotelDetailesState extends State<HotelDetailes> with TickerProviderStateMixin {
  ScrollController scrollController = ScrollController(initialScrollOffset: 0);
  var hoteltext1 = "Featuring a fitness center, Grand Royale Park Hote is located in Sweden, 4.7 km frome National Museum...";
  var hoteltext2 =
  ...
  void initState() {
    ...
    scrollController.addListener(() {
      if (context != null) {
        ...
        } else if (scrollController.offset > 0.0 && scrollController.offset < imageHieght) {
          // we need around half scrolling values
          if (scrollController.offset < ((imageHieght / 1.2))) {
            _animationController.animateTo((scrollController.offset / imageHieght));
          } else {
                      ...
                      Material(
                        ...
                        child: InkWell(
                          ...
                          onTap: () {
                            Navigator.push(
                              context,
                              MaterialPageRoute(builder: (context) => ReviewsListScreen(), fullscreenDialog: true),
                            );
                          },
                          child: Padding(
                            padding: const EdgeInsets.only(left: 8),
                          ...
                          child: InkWell(
                            ...
                            onTap: () {
                              if (scrollController.offset != 0.0) {
                                scrollController.animateTo(0.0, duration: Duration(milliseconds: 480), curve: Curves.easeInOutQuad);
                              } else {
                      ...
                      child: Container(
                        ...
                        child: Material(
                          ...
                          child: InkWell(
                            ...
                            child: Padding(
                              padding: const EdgeInsets.all(8.0),
                              child: Icon(isFav ? Icons.favorite : Icons.favorite_border, color: AppTheme.getTheme().primaryColor),
                            ),
                          ),
                        ),
                      ),
    ...
    return Positioned(
      ...
      child: AnimatedBuilder(
        ...
        builder: (BuildContext context, Widget child) {
          var opecity = 1.0 - (_animationController.value >= ((imageHieght / 1.2) / imageHieght) ? 1.0 : _animationController.value);
          return SizedBox(
            ...
            children: <Widget>[
              Text(
                ...
                style: TextStyle(
                  fontWeight: FontWeight.w600,
                  fontSize: 22,
                  color: isInList ? AppTheme.getTheme().textTheme.body1.color : Colors.white,
                ),
              ),
              Row(
                crossAxisAlignment: CrossAxisAlignment.center,
                      ...
                      child: Row(
                        children: <Widget>[
                          ...
                          Text(
                            ...
                            style: TextStyle(
                              fontSize: 14,
                              color: isInList ? AppTheme.getTheme().disabledColor : Colors.white,
                            ),
                          ),
                        ],
                      ),
